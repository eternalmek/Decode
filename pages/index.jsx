  ...
  <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md border-b border-gray-100 z-50">
    <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
      ...
      <div className="flex items-center gap-6">
        ...
        <button className="hidden sm:block text-gray-500 hover:text-gray-900 font-medium text-sm transition-colors">
          Login
        </button>
      </div>
    </div>
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-gray-900 font-sans selection:bg-blue-100">
      <Navbar setShowPricing={setShowPaywall} />
