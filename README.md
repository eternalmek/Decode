...
- The Stripe endpoint creates a Checkout session in subscription mode. After a successful purchase Stripe will redirect back to /?payment=success. The frontend stores that in localStorage as "decodr_premium" to allow unlimited analysis.
